...
class Feedback(models.Model):
    ...
    patient=models.ForeignKey('user.Patient',on_delete=models.CASCADE,related_name=("submitted_feedbacks"),verbose_name=_("Patient"))    
    doctor = models.ForeignKey('doctor.Doctor',on_delete=models.CASCADE,related_name=("received_feedbacks"),verbose_name=_("Doctor") )
    appointment = models.OneToOneField( 'appointment.Appointment', on_delete=models.SET_NULL,null=True, blank=True,related_name=("feedback"),verbose_name=_("Appointment") )
