...
class Feedback(models.Model):
    ...
    patient=models.ForeignKey('user.Patient',on_delete=models.CASCADE,related_name=_("submitted_feedbacks"),verbose_name=_("Petient"))    
    doctor = models.ForeignKey('doctor.Doctor',on_delete=models.CASCADE,related_name=_("received_feedbacks"),verbose_name=_("Doctor") )
    appointment = models.OneToOneField( 'appointments.Appointment', on_delete=models.SET_NULL,null=True, blank=True,related_name=_("Feedback"),verbose_name=_("Appointment") )
